...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-black pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Ahmad Bilal</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center">
                ...
                <span>Ahmadbsheikh15@gmail.com</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span>0331688384</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="text-center text-gray-500 border-t border-gray-800 pt-8">
          <p>&copy; {currentYear} Ahmad Bilal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
