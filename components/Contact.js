      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-2xl p-8 h-full">
              <h3 className="text-2xl font-bold text-white mb-6">Contact Information</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-gradient-to-r from-blue-600 to-purple-600 p-3 rounded-lg">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400 mt-1">Ahmadbsheikh15@gmail.com</p>
                    <p className="text-gray-500 text-sm mt-1">Send me an email anytime!</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400 mt-1">0331688384</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400 mt-1">Lahore</p>
                ...
                <div className="flex space-x-4">
                  {['github', 'linkedin', 'twitter', 'instagram'].map((social) => (
                    <motion.a
                      ...
                      whileHover={{ y: -5 }}
                      className="bg-gray-700 p-3 rounded-full text-gray-400 hover:text-white hover:bg-gray-600 transition-all duration-300"
                    >
            ...
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-2xl p-8">
              ...
              {submitSuccess ? (
                <motion.div
                  ...
                  className="bg-green-900 bg-opacity-50 border border-green-500 text-green-200 rounded-lg p-4 mb-6"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-gray-700 border-0 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-300"
